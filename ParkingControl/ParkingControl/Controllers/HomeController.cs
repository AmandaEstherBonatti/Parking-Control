...
namespace ParkingControl.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> SearchCar(string LicensePlate)
        {
            List<ParkedCar> cars = await this.parkedCarService.FindByCarLicensePlate(LicensePlate);
        ...
        {
            ParkedCar car = await this.parkedCarService.UpdateCar(id, carEdit);
            cars.Add(car);
            return RedirectToAction(nameof(Index));
        }
